        ...
        <form method="POST" action="{{ route('admin.expenses.update', $expense) }}">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title', $expense->title) }}" required autofocus
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">{{ old('description', $expense->description) }}</textarea>
